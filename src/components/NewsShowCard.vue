    ...
    <v-row>
        <v-col>
            ...
            >
                ...
                >
                    <v-card-title>
                        <h1 class="text-h3 text-wrap">{{activeStory.title}}</h1>
                    </v-card-title>
                </v-img>
                ...
                <v-card-text>
                    <!-- <div>{{activeStory.publishedAt}}</div> -->

                    <div v-html="$manatal.truncate(activeStory.content)"></div>
                </v-card-text>
...
<!--
    ...
    <p>{{activeStory.url}}</p>
    <p>{{activeStory.urlToImage}}</p>
    <p>{{activeStory.publishedAt}}</p>
